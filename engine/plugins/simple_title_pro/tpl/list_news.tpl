<table border="0" cellspacing="0" cellpadding="0" class="content" align="center">
	...
	<tr>
		<td colspan="8" class="contentEdit" align="right">
			<input class="button" onmousedown="javascript:window.location.href='{{ admin_url }}/admin.php?mod=extra-config&plugin=simple_title_pro&action=send_title&do=news'" value="Р”РѕР±Р°РІРёС‚СЊ РЅРѕРІРѕСЃС‚СЊ"/>
		</td>
	</tr>
	</tfoot>
	<tr>
