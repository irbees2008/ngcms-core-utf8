			...
			<table border="0" width="100%" cellspacing="0" cellpadding="0">
				<tr>
					...
					<td style="background-image:url('{{ tpl_url }}/images/2z_36.gif');" width="100%"><b>
							<font color="#FFFFFF">Р вЂ™Р В°РЎв‚¬Р С‘ Р В·Р В°Р С”Р В»Р В°Р Т‘Р С”Р С‘</font></b></td>
			...
			<table border="0" width="100%" cellspacing="0" cellpadding="0">
				<tr>
					...
					<td bgcolor="#FFFFFF">
						...
						<br/>
						{% if (count) %}
							<center><a href="{{ bookmarks_page }}">Р вЂ™РЎРѓР Вµ Р В·Р В°Р С”Р В»Р В°Р Т‘Р С”Р С‘</a></center>{% endif %}
					</td>
...
{% if not (count) %}Р вЂўРЎРѓР В»Р С‘ Р В·Р В°Р С”Р В»Р В°Р Т‘Р С•Р С” Р Р…Р ВµРЎвЂљ :){% endif %}