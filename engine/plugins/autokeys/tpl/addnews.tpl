<tr>
	<td width="100%" class="contentHead" colspan="3"><img src="/engine/skins/default/images/nav.gif" hspace="8" alt=""/>Р С’Р Р†РЎвЂљР С•Р С�Р В°РЎвЂљР С‘РЎвЂЎР ВµРЎРѓР С”Р В°РЎРЏ
		Р С–Р ВµР Р…Р ВµРЎР‚Р В°РЎвЂ Р С‘РЎРЏ Р С”Р В»РЎР‹РЎвЂЎР ВµР Р†РЎвЂ№РЎвЂ¦ РЎРѓР В»Р С•Р Р†
	</td>
</tr>
<tr>
	<td colspan="3">
		<table width="100%">
			<tr>
				...
				<td><label for="autokeys_generate">Р вЂњР ВµР Р…Р ВµРЎР‚Р С‘РЎР‚Р С•Р Р†Р В°РЎвЂљРЎРЉ keywords?</label></td>
			</tr>
			<tr>
				<td colspan="2">
					<div id="autokeysArea" style="border: #EEEEEE 1px solid; height: 30px; text-align: center;" onclick="autokeysAjaxUpdate();">
						.. РЎРѓР С–Р ВµР Р…Р ВµРЎР‚Р С‘РЎР‚Р С•Р Р†Р В°РЎвЂљРЎРЉ РЎРѓР ВµР в„–РЎвЂЎР В°РЎРѓ..
					</div>
					<input type="button" id="autokeysButton" value="Р СџР ВµРЎР‚Р ВµР Р…Р ВµРЎРѓРЎвЂљР С‘.." onclick="autokeysSetKeywords();"/>
			</tr>
		</table>
	</td>
</tr>
