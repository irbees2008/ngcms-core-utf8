...
function plugin_guestbook_install($action) {
	...
	switch ($action) {
		case 'confirm':
			generate_install_page('guestbook', 'Р СџР В»Р В°Р С–Р С‘Р Р… Р С—Р С•Р В·Р Р†Р С•Р В»РЎРЏР ВµРЎвЂљ Р С•РЎР‚Р С–Р В°Р Р…Р С‘Р В·Р С•Р Р†Р В°РЎвЂљРЎРЉ Р С–Р С•РЎРѓРЎвЂљР ВµР Р†РЎС“РЎР‹ Р С”Р Р…Р С‘Р С–РЎС“ Р Р…Р В° Р Р†Р В°РЎв‚¬Р ВµР С� РЎРѓР В°Р в„–РЎвЂљР Вµ<br />');
			break;
		case 'autoapply':
		case 'apply':
