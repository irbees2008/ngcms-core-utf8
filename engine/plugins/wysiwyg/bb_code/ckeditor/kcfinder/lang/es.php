...
$lang = array(
    ...
    "The uploaded file exceeds {size} bytes." => "El archivo excede el tamaР вЂњР’В±o permitido ({size} bytes).",
    "The uploaded file was only partially uploaded." => "El archivo solo fuР вЂњР’В© parcialmente cargado.",
    "No file was uploaded." => "El archivo no fuР вЂњР’В© cargado.",
    "Missing a temporary folder." => "No se puede encontrar el directorio temporal.",
    "Failed to write file." => "No se pudo crear el archivo.",
    "Denied file extension." => "ExtensiР вЂњРЎвЂ“n de archivo denegada.",
    "Unknown image format/encoding." => "Formato / codificaciР вЂњРЎвЂ“n de imagen desconocido.",
    ...
    "Incorrect .htaccess file. Cannot rewrite it!" => "Archivo .htaccess incorrecto. Р вЂ™Р Р‹No puede sobreescribirlo!",
    ...
    "Unallowable characters in folder name." => "Caracteres invР вЂњР Р‹lidos en el nombre de carpeta.",
    ...
    "Unallowable characters in file name." => "CarР вЂњР Р‹cteres invР вЂњР Р‹lidos en el nombre de archivo.",
    ...
    "Fileinfo PECL extension is missing." => "Archivo PECL con estructura errР вЂњРЎвЂ“nea.",
    "Opening fileinfo database failed." => "Error abriendo el archivo de informaciР вЂњРЎвЂ“n de la base de datos.",
    ...
    "This file is already added to the Clipboard." => "Este archivo ya fuР вЂњР’В© agregado al portapapeles.",
    ...
    "Failed to delete {count} files/folders." => "FallР вЂњРЎвЂ“ al borrar {count} archivos/carpetas.",
    "A file or folder with that name already exists." => "Existe una carpeta o archivo con el mismo nombre.",
    "Copy files here" => "Copiar archivos aquР вЂњР’В­",
    "Move files here" => "Mover archivos aquР вЂњР’В­",
    ...
    "Unable to connect!" => "Р вЂ™Р Р‹No se pudo realizar la conexiР вЂњРЎвЂ“n!",
    "Download version {version} now!" => "Р вЂ™Р Р‹Descarga la versiР вЂњРЎвЂ“n {version} ahora!",
    "KCFinder is up to date!" => "Р вЂ™Р Р‹KCFinder estР вЂњР Р‹ actualizado!",
    "Licenses:" => "Licencias:",
    "Attention" => "AtenciР вЂњРЎвЂ“n",
    "Question" => "Pregunta",
    "Yes" => "Si",
    "No" => "No",
    "You cannot rename the extension of files!" => "Р вЂ™Р Р‹Usted no puede renombrar la extensiР вЂњРЎвЂ“n de los archivos!",
    "Uploading file {number} of {count}... {progress}" => "Cargando archivo {number} de {count}... {progress}",
    "Failed to upload {filename}!" => "Р вЂ™Р Р‹No se pudo cargar el archivo {filename}!",
);
