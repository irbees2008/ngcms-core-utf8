...
$lang = array(
    ...
    "The uploaded file was only partially uploaded." => "Il file Р вЂњР Рѓ stato caricato parzialmente.",
    "No file was uploaded." => "Nessun file Р вЂњР Рѓ stato caricato",
    ...
    "Unknown image format/encoding." => "Il format/encoding dell'immagine Р вЂњР Рѓ sconosciuto.",
    "The image is too big and/or cannot be resized." => "L'immagine Р вЂњР Рѓ troppo grande e/o non puР вЂњР вЂ  essere rimpicciolita",
    "Cannot create {dir} folder." => "La cartella {dir} non puР вЂњР вЂ  essere creata.",
    "Cannot rename the folder." => "Non Р вЂњР Рѓ possibile rinominare la cartella.",
    ...
    "Incorrect .htaccess file. Cannot rewrite it!" => "Il file .htaccess Р вЂњР Рѓ corrotto. Impossibile riscriverlo!",
    ...
    "Folder name shouldn't begins with '.'" => "Il nome della cartella non puР вЂњР вЂ  iniziare con'.'",
    ...
    "File name shouldn't begins with '.'" => "Il nome del file non puР вЂњР вЂ  iniziare con '.'",
    ...
    "You can't upload such files." => "Non Р вЂњР Рѓ possibile caricare questi files.",
    ...
    "Cannot delete the folder." => "Non Р вЂњР Рѓ possibile cancellare la cartella.",
    "Click to remove from the Clipboard" => "Click per rimuoverlo dalla Clipboard",
    "This file is already added to the Clipboard." => "Questo file Р вЂњР Рѓ giР вЂњР’В  stato aggiunto alla Clipboard.",
    ...
    "The selected files are not removable." => "Il file selezionato non Р вЂњР Рѓ rimovibile.",
    ...
    "A file or folder with that name already exists." => "Un file o cartella con questo nome giР вЂњР’В  esiste.",
    ...
    "Inexistant or inaccessible folder." => "La cartella non esiste o Р вЂњР Рѓ inacessibile.",
    ...
    "KCFinder is up to date!" => "KCFinder Р вЂњР Рѓ aggiornato!",
    "Licenses:" => "Licenze:",
    ...
    "Failed to upload {filename}!" => "Il caricamento del file {filename} Р вЂњР Рѓ fallito ",
    "Close" => "Chiudi",
    "Previous" => "Precedente",
    "Next" => "Successivo",
