...
$lang = array(
    ...
    "Cannot copy '{file}'." => "Kan bestand '{file}' niet kopiР вЂњР’В«ren.",
    ...
    "{count} files in the Clipboard are not readable. Do you want to copy the rest?" => "{count} bestanden op het klembord zijn niet leesbaar. Wilt u de rest toch kopiР вЂњР’В«ren?",
