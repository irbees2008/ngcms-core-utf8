...
$lang = array(
    ...
    "Cannot move uploaded file to target folder." => "No es pot moure el fitxer pujat al directori destР вЂњР’В­",
    "Unknown error." => "Error desconegut.",
    "The uploaded file exceeds {size} bytes." => "El fitxer seleccionat excedeix el pes mР вЂњР’В xim permР вЂњР Рѓs ( {size} bytes ).",
    "The uploaded file was only partially uploaded." => "El fitxer seleccionat nomР вЂњР’В©s s'ha carregat parcialment.",
    "No file was uploaded." => "No s'ha carregat cap fitxer.",
    "Missing a temporary folder." => "Manca un directori temporal.",
    "Failed to write file." => "No s'ha pogut escriure el fitxer.",
    "Denied file extension." => "ExtensiР вЂњРЎвЂ“ de fitxer no permesa.",
    "Unknown image format/encoding." => "Format d'imatge desconegut.",
    "The image is too big and/or cannot be resized." => "La imatge Р вЂњР’В©s massa gran i/o no es pot redimensionar.",
    "Cannot create {dir} folder." => "No s'ha pogut crear el directori {dir}",
    "Cannot rename the folder." => "No es pot reanomenar el directori.",
    "Cannot write to upload folder." => "No es pot escriure al directori de cР вЂњР’В rrega de fitxers.",
    ...
    "Cannot read upload folder." => "No s'ha pogut llegir la carpeta de cР вЂњР’В rrega de fitxers.",
    "Cannot access or create thumbnails folder." => "No s'ha pogut accedir o crear la carpeta de miniatures.",
    "Cannot access or write to upload folder." => "No s'ha pogut accedir o escriure la carpeta de cР вЂњР’В rrega de fitxers.",
    "Please enter new folder name." => "Si us plau, introduР вЂњР вЂЎu el nom del nou directori.",
    "Unallowable characters in folder name." => "CarР вЂњР’В cters no permesos en el nom del directori.",
    "Folder name shouldn't begins with '.'" => "El nom d'un directori no hauria de comenР вЂњР’В§ar amb un punt '.'",
    "Please enter new file name." => "Si us plau, introduР вЂњР вЂЎu el nom del nou fitxer.",
    "Unallowable characters in file name." => "CarР вЂњР’В cters no permesos en el nom del fitxer.",
    "File name shouldn't begins with '.'" => "El nom d'un fitxer no hauria de comenР вЂњР’В§ar amb un punt '.'",
    ...
    "Fileinfo PECL extension is missing." => "Manca arxiu d'informaciР вЂњРЎвЂ“ de l'extensiР вЂњРЎвЂ“ PECL.",
    "Opening fileinfo database failed." => "Error obrint el fitxer d'informaciР вЂњРЎвЂ“ de la base de dades.",
    ...
    "Copy files here" => "Copia els fitxers aquР вЂњР’В­",
    "Move files here" => "Mou els fitxers aquР вЂњР’В­",
    ...
    "Copy {count} files" => "Copia els {count} fitxers aquР вЂњР’В­",
    "Move {count} files" => "Mou els {count} fitxers aquР вЂњР’В­",
    ...
    "Download version {version} now!" => "Descarregueu la versiР вЂњРЎвЂ“ {version}!",
    "KCFinder is up to date!" => "KCFinder estР вЂњР’В  actualitzat!",
    "Licenses:" => "LlicР вЂњР Рѓncies:",
    "Attention" => "AtenciР вЂњРЎвЂ“",
    "Question" => "Pregunta",
    "Yes" => "SР вЂњР’В­",
    "No" => "No",
    "You cannot rename the extension of files!" => "No estР вЂњР’В  permР вЂњР Рѓs canviar la extensiР вЂњРЎвЂ“ al fitxer.",
