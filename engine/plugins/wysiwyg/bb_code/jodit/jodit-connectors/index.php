...
class JoditFileBrowser {
    ...
    private function translit ($str) {
        ...
        $repl = array(
            'Р В Р’В°'=>'a','Р В Р’В±'=>'b','Р В Р вЂ '=>'v','Р В РЎвЂ“'=>'g','Р В РўвЂ�'=>'d','Р В Р’Вµ'=>'e','Р РЋРІР‚пїЅ'=>'yo','Р В Р’В¶'=>'zh','Р В Р’В·'=>'z','Р В РЎвЂ�'=>'i','Р В РІвЂћвЂ“'=>'y',
            'Р В РЎвЂќ'=>'k','Р В Р’В»'=>'l','Р В РЎпїЅ'=>'m','Р В Р вЂ¦'=>'n','Р В РЎвЂў'=>'o','Р В РЎвЂ”'=>'p','Р РЋР вЂљ'=>'r','Р РЋР С“'=>'s','Р РЋРІР‚С™'=>'t','Р РЋРЎвЂњ'=>'u','Р РЋРІР‚С›'=>'f',
            'Р РЋРІР‚В¦'=>'h','Р РЋРІР‚В '=>'ts','Р РЋРІР‚РЋ'=>'ch','Р РЋРІвЂљВ¬'=>'sh','Р РЋРІР‚В°'=>'shch','Р РЋР вЂ°'=>'','Р РЋРІР‚в„–'=>'i','Р РЋР Р‰'=>'','Р РЋР РЉ'=>'e','Р РЋР вЂ№'=>'yu','Р РЋР РЏ'=>'ya',
            ' '=>'-',
            'Р В РЎвЂ™'=>'A','Р В РІР‚пїЅ'=>'B','Р В РІР‚в„ў'=>'V','Р В РІР‚Сљ'=>'G','Р В РІР‚Сњ'=>'D','Р В РІР‚Сћ'=>'E','Р В Р С“'=>'Yo','Р В РІР‚вЂњ'=>'Zh','Р В РІР‚вЂќ'=>'Z','Р В РїС—Р…'=>'I','Р В РІвЂћСћ'=>'Y',
            'Р В РЎв„ў'=>'K','Р В РІР‚С”'=>'L','Р В РЎС™'=>'M','Р В РЎСљ'=>'N','Р В РЎвЂє'=>'O','Р В РЎСџ'=>'P','Р В Р’В '=>'R','Р В Р Р‹'=>'S','Р В РЎС›'=>'T','Р В Р в‚¬'=>'U','Р В Р’В¤'=>'F',
            'Р В РўС’'=>'H','Р В Р’В¦'=>'Ts','Р В Р’В§'=>'CH','Р В Р Рѓ'=>'Sh','Р В Р’В©'=>'Shch','Р В Р вЂћ'=>'','Р В Р’В«'=>'I','Р В Р’В¬'=>'','Р В Р’В­'=>'E','Р В Р’В®'=>'Yu','Р В Р вЂЎ'=>'Ya',
        );
