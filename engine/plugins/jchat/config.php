...
$cfgX = array();
array_push($cfgX, array('type' => 'flat', 'input' => '<tr><td class="contentEntry1" valign="top" colspan="2">Р вЂ™РЎРѓР ВµР С–Р С• Р В·Р В°Р С—Р С‘РЎРѓР ВµР в„–: ' . $jcRowCount . '</td></tr>'));
array_push($cfgX, array('type' => 'flat', 'input' => '<tr><td class="contentEntry1" valign="top" colspan="2"><input type="checkbox" name="purge" value="1"/> Р Р€Р Т‘Р В°Р В»Р С‘РЎвЂљРЎРЉ РЎРѓРЎвЂљР В°РЎР‚РЎвЂ№Р Вµ Р В·Р В°Р С—Р С‘РЎРѓР С‘, Р С•РЎРѓРЎвЂљР В°Р Р†Р С‘Р Р† Р С—Р С•РЎРѓР В»Р ВµР Т‘Р Р…Р С‘Р Вµ <input type="text" name="purge_save" size="3" value="50"/></td></tr>'));
array_push($cfgX, array('type' => 'flat', 'input' => '<tr><td class="contentEntry1" valign="top" colspan="2"><input type="checkbox" name="reload" value="1"/> Р СџР ВµРЎР‚Р ВµР В·Р В°Р С–РЎР‚РЎС“Р В·Р С‘РЎвЂљРЎРЉ РЎРѓРЎвЂљРЎР‚Р В°Р Р…Р С‘РЎвЂ РЎС“ РЎС“ Р Р†РЎРѓР ВµРЎвЂ¦ Р С—Р С•РЎРѓР ВµРЎвЂљР С‘РЎвЂљР ВµР В»Р ВµР в„–</td></tr>'));
